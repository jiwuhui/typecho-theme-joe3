<?php
/**
 * 404 页面（移植自 Halo 版 error/404.html）
 */
...
<head>
    <meta charset="utf-8" />
    <title>未找到您要的资源 - <?php $options->title(); ?></title>
    ...
    <?php $this->header('generator=&template=&pingback=&wlw=&xmlrpc=&rss1=&rss2=&atom=&commentReply=&antiSpam='); ?>
...
<div class="joe_page_404">
    <div class="error">
        <img src="<?php echo joe_asset('svg/404.svg'); ?>" alt="404" />
        <h3 class="title">“未找到您要的资源”</h3>
        <a href="<?php echo joe_site_url(); ?>/" class="error_link">回到主页</a>
    </div>
</div>
</body>
</html>
