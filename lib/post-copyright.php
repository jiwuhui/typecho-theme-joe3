...
/**
 * 文章版权信息（移植自 Halo 版 post_copyright.html）
 */
$joeCopyAuthor = (string) $this->author->screenName;
$joeCopyUrl = joe_site_url() . $this->path;
$joeRights = (string) joe_opt('passage_rights_content');
?>
<div class="joe_detail__copyright">
    <div class="content">
        <div class="item">
            ...
            <span>版权属于：</span>
            <span class="text"><?php echo $joeCopyAuthor; ?></span>
        </div>
        <div class="item">
            <svg class="icon" width="20" height="20" viewBox="0 0 1024 1024">
                <path
            ...
            <span>本文链接：</span>
            <span class="text">
                <a class="link" href="<?php echo $joeCopyUrl; ?>" target="_blank"
                   rel="noopener noreferrer nofollow"><?php echo $joeCopyUrl; ?></a>
            </span>
        </div>
        <div class="item">
            <svg class="icon" width="20" height="20" viewBox="0 0 1024 1024">
            ...
            <span class="text">
                <?php if ($joeRights !== ''): ?>
                    <?php echo $joeRights; ?>
                <?php else: ?>
                    本文使用《<a class="link" href="//creativecommons.org/licenses/by-nc-sa/4.0/deed.zh-hans"
                        target="_blank" rel="noopener noreferrer nofollow">署名-非商业性使用-相同方式共享 4.0 国际 (CC BY-NC-SA 4.0)</a>》协议授权
                <?php endif; ?>
            </span>
        </div>
    </div>
