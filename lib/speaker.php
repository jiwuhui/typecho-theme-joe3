...
/* 公告喇叭动画图标（移植自 modules/macro/speaker.html） */
?>
<div class="speaker-anim-icon">
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
         x="0px" y="0px" viewBox="0 0 200 200" xml:space="preserve" width="22px" height="22px"
         fill="var(--theme)" stroke-width="8px" stroke="var(--theme)">
        <g>
      ...
      l14.5-8.1C170.7,21.8,174.4,22.9,176.1,25.9L176.1,25.9z">
            <animate attributeName="fill-opacity" begin="0s" dur="1s" values="0;1;0" calcMode="linear" repeatCount="indefinite" />
            <animate attributeName="stroke-opacity" begin="0s" dur="1s" values="0;1;0" calcMode="linear" repeatCount="indefinite" />
        </path>
